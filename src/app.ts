  ...
  res.send(`
    ...
    <head>
        ...
        <style>
            ...
            /* Background Glows */
            .glow-1 { position: absolute; width: 350px; height: 350px; background: rgba(59, 130, 246, 0.15); filter: blur(80px); border-radius: 50%; top: -10%; left: -10%; z-index: 0; animation: pulse 8s infinite alternate; }
            .glow-2 { position: absolute; width: 350px; height: 350px; background: rgba(99, 102, 241, 0.15); filter: blur(80px); border-radius: 50%; bottom: -10%; right: -10%; z-index: 0; animation: pulse 10s infinite alternate-reverse; }
